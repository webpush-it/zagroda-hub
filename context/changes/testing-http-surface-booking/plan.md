...
- [x] 5.1 Full suite still green (`npm test`) — 52ebdf8
- [x] 5.2 Lint passes (`npm run lint`) — 52ebdf8

#### Manual

- [x] 5.3 §6.3 readable standalone — next contributor can add an HTTP-surface test from it alone — 52ebdf8
