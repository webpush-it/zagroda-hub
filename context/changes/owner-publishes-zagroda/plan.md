...
- [x] 2.6 Production Supabase dashboard configured (ops checklist)

### Phase 3: Owner Profile Panel UI

#### Automated

- [x] 3.1 Lint passes: `npm run lint` — 9d4c9a9
- [x] 3.2 Build passes: `npm run build` — 9d4c9a9
- [x] 3.3 All suites still green: `npm test` — 9d4c9a9

#### Manual

- [x] 3.4 Full mobile one-handed flow (signup → profile → turnusy → photo → publish) — 9d4c9a9
- [x] 3.5 Publish gate UX (zero-turnusy blocked, Polish message) — 9d4c9a9
- [x] 3.6 Anon sees published only; unpublish hides — 9d4c9a9
- [x] 3.7 Turnus-with-requests delete blocked with friendly 409 — 9d4c9a9
- [x] 3.8 Photo replace works (old object cleaned up) — 9d4c9a9
