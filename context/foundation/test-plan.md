...
| 2   | E2E critical flow on mobile viewport              | One scripted phone-size browser run of the core promise (request → accept → overbooking block), wired to fail CI                              | #3             | e2e                                  | implementing | context/changes/testing-e2e-critical-flow-mobile/        |
