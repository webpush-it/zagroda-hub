...
`;
  ...
  console.error(
    "✗ Nie udało się wygenerować assetów brandu. Uruchom z katalogu głównego repo " +
      "(node scripts/generate-brand-assets.mjs) i upewnij się, że istnieją public/favicon.svg " +
      "oraz scripts/fonts/nunito-{400,800}-subset.ttf.",
  );
  console.error(err);
  process.exit(1);
}
